...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Account.deleted'
        db.add_column('billing_account', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Subscriber.deleted'
        db.add_column('billing_subscriber', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Account.deleted'
        db.delete_column('billing_account', 'deleted')

        # Deleting field 'Subscriber.deleted'
        db.delete_column('billing_subscriber', 'deleted')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 16, 19, 19, 45, 917510)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 16, 19, 19, 45, 917438)'}),
