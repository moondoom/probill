...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrafficByPeriod.tariff'
        db.alter_column('billing_trafficbyperiod', 'tariff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Tariff'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TrafficByPeriod.tariff'
        raise RuntimeError("Cannot reverse this migration. 'TrafficByPeriod.tariff' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 30, 20, 51, 43, 42215)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 30, 20, 51, 43, 42134)'}),
