...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OsmpPay'
        db.create_table('billing_osmppay', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('process_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('pay_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('command', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('osmp_txn_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('prv_txn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.AccountHistory'], null=True)),
        ...
        db.send_create_signal('billing', ['OsmpPay'])
    ...
    def backwards(self, orm):
        # Deleting model 'OsmpPay'
        db.delete_table('billing_osmppay')
    ...
    models = {
        ...
        'billing.subscriber': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['billing.Region']", 'null': 'True', 'on_delete': 'models.SET_NULL'})
        },
        'billing.tariff': {
