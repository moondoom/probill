...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VisaPay'
        db.create_table('billing_visapay', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gpb_trx_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ...
            ('state', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True)),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('end', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('check_req_body', self.gf('django.db.models.fields.TextField')(null=True)),
            ('check_resp_body', self.gf('django.db.models.fields.TextField')(null=True)),
            ('pay_req_body', self.gf('django.db.models.fields.TextField')(null=True)),
            ('pay_resp_body', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('billing', ['VisaPay'])


        # Changing field 'Account.tariff'
        db.alter_column('billing_account', 'tariff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Tariff'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Subscriber.region'
        db.alter_column('billing_subscriber', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Region'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting model 'VisaPay'
        db.delete_table('billing_visapay')


        # Changing field 'Account.tariff'
        db.alter_column('billing_account', 'tariff_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Tariff'], null=True))

        # Changing field 'Subscriber.region'
        db.alter_column('billing_subscriber', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Region'], null=True))
