...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrustPay'
        db.create_table('billing_trustpay', (
            ...
            ('trust_days', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default='5')),
            ('value', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Manager'], null=True, blank=True)),
        ))
        db.send_create_signal('billing', ['TrustPay'])
    ...
    def backwards(self, orm):
        # Deleting model 'TrustPay'
        db.delete_table('billing_trustpay')
