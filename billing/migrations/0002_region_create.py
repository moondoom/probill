...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Region'
        db.create_table('billing_region', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('billing', ['Region'])

        # Adding field 'Subscriber.region'
        db.add_column('billing_subscriber', 'region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Region'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Region'
        db.delete_table('billing_region')

        # Deleting field 'Subscriber.region'
        db.delete_column('billing_subscriber', 'region_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 28, 20, 0, 50, 192485)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 28, 20, 0, 50, 192409)'}),
