...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.ip'
        db.alter_column('billing_account', 'ip', self.gf('probill.lib.networks.IPAddressField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Account.ip'
        db.alter_column('billing_account', 'ip', self.gf('probill.lib.networks.IPAddressField')(default='0.0.0.0', unique=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 19, 54, 19, 515968)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 19, 54, 19, 515752)'}),
