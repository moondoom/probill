...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Account', fields ['ip']
        db.delete_unique('billing_account', ['ip'])

        # Adding model 'AccountLog'
        db.create_table('billing_accountlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Account'])),
            ('old_status', self.gf('django.db.models.fields.IntegerField')()),
            ('new_status', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('billing', ['AccountLog'])

        # Adding field 'Account.status'
        db.add_column('billing_account', 'status', self.gf('django.db.models.fields.IntegerField')(default=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'AccountLog'
        db.delete_table('billing_accountlog')

        # Deleting field 'Account.status'
        db.delete_column('billing_account', 'status')

        # Adding unique constraint on 'Account', fields ['ip']
        db.create_unique('billing_account', ['ip'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 13, 55, 15, 217759)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 21, 13, 55, 15, 217679)'}),
        ...
        'billing.account': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('probill.lib.networks.IPAddressField', [], {'db_index': 'True'}),
