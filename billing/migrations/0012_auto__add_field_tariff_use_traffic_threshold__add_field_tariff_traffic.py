...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tariff.use_traffic_threshold'
        db.add_column('billing_tariff', 'use_traffic_threshold', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Tariff.traffic_threshold'
        db.add_column('billing_tariff', 'traffic_threshold', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tariff.use_traffic_threshold'
        db.delete_column('billing_tariff', 'use_traffic_threshold')

        # Deleting field 'Tariff.traffic_threshold'
        db.delete_column('billing_tariff', 'traffic_threshold')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 29, 22, 35, 38, 338927)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 29, 22, 35, 38, 338846)'}),
