...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UpLink.speed'
        db.add_column('nas_uplink', 'speed', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UpLink.speed'
        db.delete_column('nas_uplink', 'speed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 14, 3, 3, 602839)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 26, 14, 3, 3, 602760)'}),
        ...
        'billing.subscriber': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['billing.Region']", 'null': 'True', 'blank': 'True'})
        },
        'billing.tariff': {
