...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NetFlowSource'
        db.create_table('nas_netflowsource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nas', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nas.NasServer'])),
            ('file_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('file_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('file_dir', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('nas', ['NetFlowSource'])


    def backwards(self, orm):
        
        # Deleting model 'NetFlowSource'
        db.delete_table('nas_netflowsource')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 2, 19, 35, 24, 452021)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 2, 19, 35, 24, 451949)'}),
