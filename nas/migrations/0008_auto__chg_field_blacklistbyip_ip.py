...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlackListByIP.ip'
        db.alter_column('nas_blacklistbyip', 'ip', self.gf('probill.lib.networks.IPNetworkField')())

    def backwards(self, orm):

        # Changing field 'BlackListByIP.ip'
        db.alter_column('nas_blacklistbyip', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15))
