...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlackListByIP'
        db.create_table('nas_blacklistbyip', (
        ...
        db.send_create_signal('nas', ['BlackListByIP'])


    def backwards(self, orm):
        # Deleting model 'BlackListByIP'
        db.delete_table('nas_blacklistbyip')
