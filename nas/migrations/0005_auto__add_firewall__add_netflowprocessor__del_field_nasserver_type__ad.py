...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nas_firewall', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nas', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nas.NasServer'])),
            ('kind', self.gf('django.db.models.fields.CharField')(default='freebsd_ipfw', max_length='20')),
        ))
        db.send_create_signal('nas', ['Firewall'])

        # Adding model 'NetFlowProcessor'
        db.create_table('nas_netflowprocessor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nas', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nas.NasServer'])),
            ('flow_source_path', self.gf('django.db.models.fields.CharField')(default='/usr/local/flowdata/%Y/%Y-%m/%Y-%m-%d', max_length=100)),
            ('flow_source_time_mask', self.gf('django.db.models.fields.CharField')(default='ft-v05.%Y-%m-%d.%H%M%S', max_length=100)),
            ('flow_tools_path', self.gf('django.db.models.fields.CharField')(default='/usr/local/bin', max_length=100)),
        ))
        db.send_create_signal('nas', ['NetFlowProcessor'])

        # Deleting field 'NasServer.type'
        db.delete_column('nas_nasserver', 'type')

        # Adding field 'NasServer.local'
        db.add_column('nas_nasserver', 'local',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('nas_firewall')

        # Deleting model 'NetFlowProcessor'
        db.delete_table('nas_netflowprocessor')

        # Adding field 'NasServer.type'
        db.add_column('nas_nasserver', 'type',
                      self.gf('django.db.models.fields.CharField')(default='freebsd_ipfw', max_length='20'),
                      keep_default=False)

        # Deleting field 'NasServer.local'
        db.delete_column('nas_nasserver', 'local')
    ...
    models = {
        ...
        'nas.firewall': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.CharField', [], {'default': "'freebsd_ipfw'", 'max_length': "'20'"}),
            'nas': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nas.NasServer']"})
        },
        'nas.ipinterface': {
        ...
        'nas.netflowprocessor': {
            'Meta': {'object_name': 'NetFlowProcessor'},
            'flow_source_path': ('django.db.models.fields.CharField', [], {'default': "'/usr/local/flowdata/%Y/%Y-%m/%Y-%m-%d'", 'max_length': '100'}),
            'flow_source_time_mask': ('django.db.models.fields.CharField', [], {'default': "'ft-v05.%Y-%m-%d.%H%M%S'", 'max_length': '100'}),
            'flow_tools_path': ('django.db.models.fields.CharField', [], {'default': "'/usr/local/bin'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nas': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nas.NasServer']"})
        },
        'nas.netflowsource': {
