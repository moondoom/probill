...
class TblBankpay(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    usercode = models.IntegerField(null=True, db_column='USERCODE', blank=True) # Field name made lowercase.
    dateadd = models.DateTimeField(null=True, db_column='DATEADD', blank=True) # Field name made lowercase.
    summa = models.FloatField(null=True, db_column='SUMMA', blank=True) # Field name made lowercase.
    bank = models.CharField(max_length=750, db_column='BANK', blank=True) # Field name made lowercase.
    dateplat = models.DateTimeField(null=True, db_column='DATEPLAT', blank=True) # Field name made lowercase.
    kvitan = models.CharField(max_length=150, db_column='KVITAN', blank=True) # Field name made lowercase.
    info = models.TextField(db_column='INFO', blank=True) # Field name made lowercase.
    dateget = models.DateTimeField(null=True, db_column='DATEGET', blank=True) # Field name made lowercase.
    admincomment = models.CharField(max_length=750, db_column='ADMINCOMMENT', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'tbl_bankpay'
...
class TblBaseOld(models.Model):
    ...
    dateadd = models.DateTimeField(null=True, db_column='DATEADD', blank=True) # Field name made lowercase.
    usercode = models.IntegerField(null=True, db_column='USERCODE', blank=True) # Field name made lowercase.
    dateinnet = models.DateTimeField(null=True, db_column='DATEINNET', blank=True) # Field name made lowercase.
    class Meta:
...
class TblCeleb(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    nazvcode = models.CharField(max_length=75, db_column='NAZVCODE', blank=True) # Field name made lowercase.
    nazv = models.CharField(max_length=600, db_column='NAZV', blank=True) # Field name made lowercase.
    nazvlang = models.IntegerField(null=True, db_column='NAZVLANG', blank=True) # Field name made lowercase.
    ...
    celebcolor = models.CharField(max_length=18, db_column='CELEBCOLOR', blank=True) # Field name made lowercase.
    pict1 = models.CharField(max_length=300, db_column='PICT1', blank=True) # Field name made lowercase.
    pict2 = models.CharField(max_length=300, db_column='PICT2', blank=True) # Field name made lowercase.
    active = models.IntegerField(null=True, db_column='ACTIVE', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'tbl_celeb'

class TblChange(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    usercode = models.IntegerField(null=True, db_column='USERCODE', blank=True) # Field name made lowercase.
    param = models.CharField(max_length=150, db_column='PARAM', blank=True) # Field name made lowercase.
    value = models.CharField(max_length=750, db_column='VALUE', blank=True) # Field name made lowercase.
    oldvalue = models.CharField(max_length=750, db_column='OLDVALUE', blank=True) # Field name made lowercase.
    dateadd = models.DateTimeField(null=True, db_column='DATEADD', blank=True) # Field name made lowercase.
    dateyes = models.DateTimeField(null=True, db_column='DATEYES', blank=True) # Field name made lowercase.
    oper = models.IntegerField(null=True, db_column='OPER', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'tbl_change'
...
class TblConfJournal(models.Model):
    ...
    pict = models.CharField(max_length=765, db_column='PICT', blank=True) # Field name made lowercase.
    inmain = models.IntegerField(null=True, db_column='INMAIN', blank=True) # Field name made lowercase.
    spwork = models.IntegerField(null=True, db_column='SPWORK', blank=True) # Field name made lowercase.
    textindop = models.CharField(max_length=765, db_column='TEXTINDOP', blank=True) # Field name made lowercase.
...
class TblConfJournalDopf(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    ...
    class Meta:
        db_table = u'tbl_conf_journal_dopf'
...
class TblConfJournalUp(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    typecode = models.IntegerField(null=True, db_column='TYPECODE', blank=True) # Field name made lowercase.
    newtypecode = models.IntegerField(null=True, db_column='NEWTYPECODE', blank=True) # Field name made lowercase.
    perscode = models.IntegerField(null=True, db_column='PERSCODE', blank=True) # Field name made lowercase.
    podrazdcode = models.IntegerField(null=True, db_column='PODRAZDCODE', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'tbl_conf_journal_up'
...
class TblMap(models.Model):
    ...
    opis = models.CharField(max_length=600, db_column='OPIS', blank=True) # Field name made lowercase.
    dateadd = models.DateTimeField(null=True, db_column='DATEADD', blank=True) # Field name made lowercase.
    y3d = models.IntegerField(null=True, db_column='Y3D', blank=True) # Field name made lowercase.
...
class TblOper(models.Model):
    ...
    regionsize = models.IntegerField(null=True, db_column='REGIONSIZE', blank=True) # Field name made lowercase.
...
class TblTovartype(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    tovartype = models.CharField(max_length=150, db_column='TOVARTYPE', blank=True) # Field name made lowercase.
...
class TblVlan(models.Model):
    ...
    vlanno = models.IntegerField(null=True, db_column='VLANNO', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'tbl_vlan'

class TblVoip(models.Model):
    code = models.IntegerField(primary_key=True, db_column='CODE') # Field name made lowercase.
    usercode = models.IntegerField(null=True, db_column='USERCODE', blank=True) # Field name made lowercase.
    status = models.IntegerField(null=True, db_column='STATUS', blank=True) # Field name made lowercase.
    dateadd = models.DateTimeField(null=True, db_column='DATEADD', blank=True) # Field name made lowercase.
    datefinish = models.DateTimeField(null=True, db_column='DATEFINISH', blank=True) # Field name made lowercase.
    whoaprove = models.IntegerField(null=True, db_column='WHOAPROVE', blank=True) # Field name made lowercase.
    phoneno = models.CharField(max_length=60, db_column='PHONENO', blank=True) # Field name made lowercase.
    phonepass = models.CharField(max_length=750, db_column='PHONEPASS', blank=True) # Field name made lowercase.
    isshow = models.IntegerField(null=True, db_column='ISSHOW', blank=True) # Field name made lowercase.
    isservice = models.IntegerField(null=True, db_column='ISSERVICE', blank=True) # Field name made lowercase.
    opis = models.CharField(max_length=750, db_column='OPIS', blank=True) # Field name made lowercase.
    opis2 = models.CharField(max_length=750, db_column='OPIS2', blank=True) # Field name made lowercase.
    ishard = models.IntegerField(null=True, db_column='ISHARD', blank=True) # Field name made lowercase.
    class Meta:
        db_table = u'tbl_voip'
