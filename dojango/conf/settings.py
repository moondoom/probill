...
DOJO_VERSION = getattr(settings, "DOJANGO_DOJO_VERSION", "")
...
_google_versions = ('1.7', '1.7.0', '1.7.1', '1.7.2','1.8.0') # since Dojo 1.7.0 an alternative loading mechanism is in place
DOJO_PROFILES = {
    ...
    'local': {'base_url': '/media/jq/dojo', 'is_local':True}, # we don't have a restriction on version names, name them as you like
    'local_release': {'base_url': '/media/jq/dojo', 'is_local':True, 'is_local_build':True}, # this will be available after the first dojo build!
